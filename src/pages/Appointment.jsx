          ...
          <div className = "flex item-center gap-3 w-full overflow-x-auto no-scrollbar mt-4">
            {
              docSlots.length && docSlots[slotIndex].map((item,index)=>(
                ...
                className = {`text-sm font-light flex-shrink px-5 py-2 rounded-full cursor-pointer ${item.time === slotTime ? 'bg-primary text-white' : 'border border-gray-200'}`} key = {index}>
